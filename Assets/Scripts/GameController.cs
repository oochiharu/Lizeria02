...
namespace Lizeria02
{
    public class GameController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            scoreText = ValidateTextReference(scoreText, "ScoreText");
            timerText = ValidateTextReference(timerText, "TimerText");
            messageText = ValidateTextReference(messageText, "MessageText");
        ...
        private Text ValidateTextReference(Text reference, string name)
        {
            if (reference != null)
            {
                return reference;
        ...
        private void SpawnPickup()
        {
            ...
            {
                pickupGo.transform.SetParent(pickupContainer);
            }
